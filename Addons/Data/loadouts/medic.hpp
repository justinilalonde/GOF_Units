		...
		linkedItems[] = {"rhsusf_iotv_ocp_Medic","rhsusf_ach_helmet_ocp_norotos","ItemMap","ItemCompass","tf_microdagr","tf_anprc152","ItemGPS","NVGREG"};
		
		respawnLinkedItems[] = {"rhsusf_iotv_ocp_Medic","rhsusf_ach_helmet_ocp_norotos","ItemMap","ItemCompass","tf_microdagr","tf_anprc152","ItemGPS","NVGREG"};
