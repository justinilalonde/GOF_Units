		...
		linkedItems[] = {"V_TacVest_oli","H_PilotHelmetFighter_O","ItemMap","ItemCompass","tfmicrodagr","tfanprc152_10","ItemGPS","NVGTL"};
		
		respawnLinkedItems[] = {"V_TacVest_oli","H_PilotHelmetFighter_O","ItemMap","ItemCompass","tfmicrodagr","tfanprc152_10","ItemGPS","NVGTL"};
