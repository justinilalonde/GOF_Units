		...
		linkedItems[] = {"rhsusf_iotv_ocp_Squadleader","rhsusf_ach_helmet_headset_ocp","ItemMap","ItemCompass","tf_microdagr","tf_anprc152","itemcTab","NVGTL"};
		
		respawnLinkedItems[] = {"rhsusf_iotv_ocp_Squadleader","rhsusf_ach_helmet_headset_ocp","ItemMap","ItemCompass","tf_microdagr","tf_anprc152","itemcTab","NVGTL"};
